...
from opentad.cores import feature_extraction, eval_one_epoch
...
def main():
    ...
    # test the detector
    logger.info("Feature Extraction Starts...\n")
    feature_extraction(
        test_loader,
        model,
        cfg,
    ...
    logger.info("Feature Extraction Over...\n")
